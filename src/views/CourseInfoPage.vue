<template>
    <div class="home">
        ...
        <div class="info">
            <CourseInfoCard title="Nombre del curso" description="Descripcion del curso" alumnos="26"></CourseInfoCard>
        </div>
        ...
        <div class="cards_container">
            <div class="column">
                <HomeworkCard title="Meta 1.1 - Hola como estas" vencimiento="14/05/2023"></HomeworkCard>
                <HomeworkCard title="Meta 1.2 - Buenas tardes" vencimiento="14/05/2023"></HomeworkCard>
                <HomeworkCard title="Meta 1.3 - Ingenieria de Software" vencimiento="14/05/2023"></HomeworkCard>
                <HomeworkCard title="Meta 1.4 - Ingenieria de Software" vencimiento="14/05/2023"></HomeworkCard>
            </div>
        </div>
